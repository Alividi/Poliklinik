...
public class NotifikasiPasienModel {
    String id;
    String nmPasien;
    String nmDokter;
    String idRM;
    ...
    public NotifikasiPasienModel() {

    }

    public NotifikasiPasienModel(String id, String nmPasien, String nmDokter, String idRM, String tanggal, String statusRM, String statusDT, String statusPS) {
        this.id = id;
