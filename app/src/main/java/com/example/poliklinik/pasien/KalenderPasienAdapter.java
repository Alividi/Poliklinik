...
public class KalenderPasienAdapter extends RecyclerView.Adapter<KalenderPasienAdapter.MyViewHolder> {
    Context context;
    ...
    public KalenderPasienAdapter(Context context, ArrayList<JadwalPasienModel> jadwalPasienModels) {
    ...
    @NonNull
    @Override
    public KalenderPasienAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater =  LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.recycler_jadwal_konsultasi_pasien, parent, false);
        return new KalenderPasienAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull KalenderPasienAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
    ...
    public int getItemCount() {
        return jadwalPasienModels.size();
    }
