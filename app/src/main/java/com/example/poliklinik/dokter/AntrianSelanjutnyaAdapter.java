...
public class AntrianSelanjutnyaAdapter extends RecyclerView.Adapter<AntrianSelanjutnyaAdapter.MyViewHolder> {
    Context context;
    ArrayList<AntrianDokterModel> antrianDokterModels;
    String url;
    RequestQueue queue;

    public AntrianSelanjutnyaAdapter(Context context, ArrayList<AntrianDokterModel> antrianDokterModels) {
    ...
    @NonNull
    @Override
    public AntrianSelanjutnyaAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.recycler_antrian_dokter,parent,false);
        return new AntrianSelanjutnyaAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AntrianSelanjutnyaAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
