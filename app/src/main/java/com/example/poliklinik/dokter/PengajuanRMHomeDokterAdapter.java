...
public class PengajuanRMHomeDokterAdapter extends RecyclerView.Adapter<PengajuanRMHomeDokterAdapter.MyViewHolder> {
    Context context;
    ...
    public PengajuanRMHomeDokterAdapter(Context context, ArrayList<PengajuanRmDokterModel> pengajuanRmDokterModels) {
    ...
    @NonNull
    @Override
    public PengajuanRMHomeDokterAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.recycler_p_rekam_medis_dokter,parent,false);
        return new PengajuanRMHomeDokterAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PengajuanRMHomeDokterAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.btnAcc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                statusNotif();
                pengajuanRmDokterModels.remove(position);
